...
<head>
    ...
    <title>Haebot | @yield('tittle')</title>
...
<body class="">
    ...
    <main class="main-content">
        <div class="position-relative iq-banner">
            ...
            <!--Nav Start-->
            <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar" style="margin-bottom: 70px">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" data-bs-scroll="true"
        ...
        <div class="offcanvas-header">
            <div class="d-flex align-items-center">
                <h3 class="offcanvas-title me-3" id="offcanvasExampleLabel">Pengaturan Tema</h3>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="mt-4 mb-3">Warna Lain</h5>
                    ...
                    <h5 class="mt-4 mb-3">Warna Sidebar</h5>
                    ...
                    <h5 class="mt-4 mb-3">Tipe Sidebar</h5>
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                    ...
                    <h5 class="mt-4 mb-3">Model Sidebar</h5>
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="text-center">
