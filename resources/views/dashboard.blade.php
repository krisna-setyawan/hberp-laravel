                    ...
                    <div class="card-body">
                        <div class="d-grid gap-card grid-cols-3">
                            ...
                            <a data-fslightbox="gallery" href="../../assets/images/icons/02.png">
                                <img src="../../assets/images/icons/02.png" class="img-fluid bg-soft-warning rounded"
                                    alt="profile-image">
                            </a>
                            ...
                            <a data-fslightbox="gallery" href="../../assets/images/icons/05.png">
                                <img src="../../assets/images/icons/05.png" class="img-fluid bg-soft-danger rounded"
                                    alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="../../assets/images/shapes/04.png">
                                <img src="../../assets/images/shapes/04.png" class="img-fluid bg-soft-primary rounded"
                        ...
                        <div class="twit-feed">
                            <div class="d-flex align-items-center mb-2">
                                <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-primary"
                                    src="../../assets/images/icons/04.png" alt="">
                                <div class="media-support-info">
                    ...
                    <div id="profile-feed" class="tab-pane fade active show">
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <div class="user-post">
                                    <a href="javascript:void(0);"><img src="../../assets/images/pages/02-page.png"
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center mb-1">
                                                        <a href="javascript:void(0);" class="me-3">
                                                            <svg width="20" class="text-body me-1 icon-20"
                                                                viewBox="0 0 24 24">
                                                                <path fill="currentColor"
                                                                    d="M12.1,18.55L12,18.65L11.89,18.55C7.14,14.24 4,11.39 4,8.5C4,6.5 5.5,5 7.5,5C9.04,5 10.54,6 11.07,7.36H12.93C13.46,6 14.96,5 16.5,5C18.5,5 20,6.5 20,8.5C20,11.39 16.86,14.24 12.1,18.55M16.5,3C14.76,3 13.09,3.81 12,5.08C10.91,3.81 9.24,3 7.5,3C4.42,3 2,5.41 2,8.5C2,12.27 5.4,15.36 10.55,20.03L12,21.35L13.45,20.03C18.6,15.36 22,12.27 22,8.5C22,5.41 19.58,3 16.5,3Z" />
                                                            </svg>
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <div class="media-support-user-img me-3">
                                            <img class="rounded-pill img-fluid avatar-60 p-1 bg-soft-info"
                                                src="../../assets/images/avatars/05.png" alt="">
                                        </div>
                                        <div class="media-support-info mt-2">
                    ...
                    <div class="card-body">
                        <ul class="list-inline m-0 p-0 ">
                            <li class="d-flex mb-4 align-items-center active">
                                <img src="../../assets/images/icons/06.png" alt="story-img"
                                    class="rounded-pill avatar-70 p-1 profile-story-img border bg-soft-light img-fluid">
                                <div class="ms-3">
                                    <h5>Web Design</h5>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <img src="../../assets/images/icons/03.png" alt="story-img"
                            ...
                            <li class="d-flex align-items-center">
                                <img src="../../assets/images/icons/07.png" alt="story-img"
                        ...
                        <ul class="list-inline m-0 p-0">
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-warning rounded-pill"><img
                                        src="../../assets/images/icons/05.png" alt="story-img"
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-danger rounded-pill"><img
                                        src="../../assets/images/icons/03.png" alt="story-img"
                                        class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Robert Fox</h6>
                                    <p class="mb-0">4 mutual friends</p>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-dark rounded-pill"><img
                                        src="../../assets/images/icons/06.png" alt="story-img"
                                        class="rounded-pill  profile-story-img avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Jenny Wilson</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-primary rounded-pill"><img
                                        src="../../assets/images/icons/07.png" alt="story-img"
                                        class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Cody Fisher</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-info rounded-pill"><img
                                        src="../../assets/images/icons/04.png" alt="story-img"
                                        class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Bessie Cooper</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-warning rounded-pill"><img
                                        src="../../assets/images/icons/02.png" alt="story-img"
                                        class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Wade Warren</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-success rounded-pill"><img
                                        src="../../assets/images/icons/01.png" alt="story-img"
                                        class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                    <h6>Guy Hawkins</h6>
